...
#16281 MAX
maxData = 81
data = json.load(open('bruins_10_11.json'))
sat = json.load(open('SAT_bruins_10_11.json'))
hit = json.load(open('HIT_bruins_10_11.json'))
# Add misses stat
#Calculate Fenwick for

with open('bruins_10_11_season.csv','w') as new_file:
